                ...
                <div className="l-form">
                    <form action='' onSubmit={handleOnSubmit}>
                        <div className="l-input-container">
                            <input type="text" id="username" name="fullName" value={fullName} placeholder='username' onChange={(e) => setFullName(e.target.value)} required />
                        </div>
                        <div className="l-input-container">
                            <input type="email" id="email" name="email" value={email} placeholder='email' onChange={(e) => setEmail(e.target.value)} required  />
                        </div>
                        <div className="l-input-container">
                            <input type="password" id="password" name="password" value={password} placeholder='password' onChange={(e) => setPassword(e.target.value)} required />
                        </div>
                        ...
                        <button type="submit"  onClick={handleOnSubmit}>SignUp</button>
